...
def reporte():
    ...
    #Removemos las respuestas innecesarias
    respuestas.remove('SI, CON material (Banderin,banderola,poster)')
    respuestas.remove('SI')
    ...
    for i in respuestas:
        ...
        for j in asesores:
            ...
            dict[j].append(len(asesor_n[asesor_respuesta]))
